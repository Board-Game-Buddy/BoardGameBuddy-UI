    ...
    return (
        <div className='card'>
          <div className='image-container'>
            ...
            {isFavorite ? (
              <img className='filled' src={filled} alt='filled in collection icon showing that this game is saved to the users favorites' style={{cursor: 'pointer', fontSize: '1.3em'}} />
              ) : (
              <img className='unfilled' src={unfilled} alt='unfilled collection icon showing that this game is not saved to the users favorites' style={{fontSize: '1.3em'}} />
            )}
          </div>
        </div>
      </div>
